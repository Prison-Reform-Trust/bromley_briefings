...
"""
A Plotly chart showing the sentence breakdown for Serious Terrorism Sentences.
...
TITLE = ""
SUBTITLE = "Based on a custodial term of 14 years (the set period) and an extended licence period of 16 years"
SOURCE = ""
...
ANNOTATION_CONFIGS = [
    ...
    {"text": "End", "x": 214.3, "xanchor": "right", "y": 1, "yanchor": "bottom"},
    {"text": prt_theme.wrap_labels("Automatic release", max_chars=13), "x": LINE_POSITIONS[0], "xanchor": "center"},
]
...
def generate_traces() -> list:
    ...
    traces = [
        go.Bar(
            ...
            y=[1],
            orientation="h",
            text=prt_theme.wrap_labels(f"{LINE_POSITIONS[0]}% of custodial term", max_chars=15),
            textposition="inside",
        ...
        go.Bar(
            x=[214.3 - LINE_POSITIONS[0]],
            y=[1],
            orientation="h",
            text=prt_theme.wrap_labels("7–25 years", max_chars=15),
            textposition="inside",
            textfont_color="white",
            textfont_size=16,
            insidetextanchor="middle",
            hovertemplate="Extended<br>licence period<extra></extra>",
            marker_color=colorway[4],
            width=7,
        ),
    ]
