...
"""
A Plotly chart showing the sentence breakdown for IPP sentences.
...
TITLE = ""
SUBTITLE = "Based on a custodial tariff of 4 years (the average tariff of unreleased people serving an IPP in prison) and an assumption of living for 40 years after release"
SOURCE = ""
...
LINE_POSITIONS = [9.1, 13]
ANNOTATION_CONFIGS = [
    {"text": "Start", "x": 0, "xanchor": "left", "y": 1, "yanchor": "bottom"},
    {"text": "End of life", "x": 96.1, "xanchor": "right", "y": 1, "yanchor": "bottom"},
    {"text": prt_theme.wrap_labels("Discretionary release", max_chars=13), "x": LINE_POSITIONS[0] + 1, "xanchor": "center"},
    {"text": prt_theme.wrap_labels("Licence review", max_chars=13), "x": LINE_POSITIONS[1], "xanchor": "left", "y": 1, "yanchor": "bottom"},
]
...
def create_chart() -> go.Figure:
    ...
    # Configure layout
    fig.update_layout(
        height=150,  # Added extra height to accommodate annotations and added margin
        margin={'t': 35, 'b': 35, 'l': 0, 'r': 0, 'pad': 0, 'autoexpand': False},
