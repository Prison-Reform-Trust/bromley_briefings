...
"""
A Plotly chart showing the sentence breakdown for SOPC sentences.
...
TITLE = ""
SUBTITLE = "Based on a custodial term of 10 years (the average term of a SOPC in 2024)"
SOURCE = ""
...
def generate_traces() -> list:
    ...
    traces = [
        ...
        go.Bar(
            x=[110 - LINE_POSITIONS[1]],
            y=[1],
            orientation="h",
            text=prt_theme.wrap_labels("1 year", max_chars=15),
            textposition="inside",
            textfont_color="white",
            textfont_size=16,
