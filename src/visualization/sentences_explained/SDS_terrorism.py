...
"""
A Plotly chart showing the sentence breakdown SDS sentences for terrorism offences.
...
TITLE = ""
SUBTITLE = "Standard determinate sentences for terrorism offences"
SOURCE = ""
OUTPUT_PATH = utils.get_output_path(
    section='sentences_explained',
    filename='SDS_terrorism.html'
)
...
ANNOTATION_CONFIGS = [
    ...
    {"text": prt_theme.wrap_labels("Discretionary release", max_chars=13), "x": LINE_POSITIONS[-1], "xanchor": "center"},
]
