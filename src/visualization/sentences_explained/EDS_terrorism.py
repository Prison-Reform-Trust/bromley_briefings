...
"""
A Plotly chart showing the sentence breakdown for EDS sentences for terrorism offences.
...
TITLE = ""
SUBTITLE = "EDS for terror offences"
SOURCE = ""
OUTPUT_PATH = utils.get_output_path(
    section='sentences_explained',
    filename='EDS_terrorism.html'
)
...
ANNOTATION_CONFIGS = [
    ...
    {"text": "End", "x": 200, "xanchor": "right", "y": 1, "yanchor": "bottom"},
...
def generate_traces() -> list:
    ...
    traces = [
        ...
        go.Bar(
            x=[200 - LINE_POSITIONS[0]],
            y=[1],
            orientation="h",
            text=prt_theme.wrap_labels("Up to 10 years", max_chars=15),
            textposition="inside",
            textfont_color="white",
            textfont_size=16,
