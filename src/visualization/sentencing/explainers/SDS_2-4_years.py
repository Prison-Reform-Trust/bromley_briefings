...
#Read in datasets.
data = pd.read_csv("data/processed/sentence_explainers/SDS_2-4_years.csv")
...
#Release point
ax.text(49, 0.02,"50% of\ncustodial term", color='white', ha='right', va='center', size=10, zorder=4)
ax.text(50, 1.05,"Automatic release", ha='center', va='center', size=9, zorder=4)
ax.text(50, -1.2,"Sentences of 2–4 years", ha='center', va='center', size=10, zorder=5)
...
###PRINTING FIGURE###
plt.savefig("reports/figures/sentencing/explainers/SDS_2-4_years.svg", bbox_inches='tight', transparent=True)