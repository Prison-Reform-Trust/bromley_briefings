...
#Read in datasets.
data = pd.read_csv("data/processed/sentence_explainers/SDS_terror.csv")
...
ax.text(66.6, 1.05,"Conditional release", ha='center', va='center', size=7, zorder=4)
...
###PRINTING FIGURE###
plt.savefig("reports/figures/sentencing/explainers/SDS_terror.svg", bbox_inches='tight', transparent=True)